...
namespace MyCompanyName.AbpZeroTemplate.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTopBar
{
    public class AppAreaNameTopBarViewComponent : AbpZeroTemplateViewComponent
    {
