...
import { ViewCoronaModalComponent } from './virus/coronas/view-corona-modal.component';
import { CreateOrEditCoronaModalComponent } from './virus/coronas/create-or-edit-corona-modal.component';
...
@NgModule({
    ...
    declarations: [
		CoronasComponent,
		ViewCoronaModalComponent,		CreateOrEditCoronaModalComponent,
        DashboardComponent,
        PhoneBookComponent,
