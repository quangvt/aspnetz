...
@Injectable()
export class CoronasServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @param symptomFilter (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(filter: string | undefined, nameFilter: string | undefined, symptomFilter: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PagedResultDtoOfGetCoronaForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Coronas/GetAll?";
        if (filter === null)
        ...
        if (symptomFilter === null)
            throw new Error("The parameter 'symptomFilter' cannot be null.");
        else if (symptomFilter !== undefined)
            url_ += "SymptomFilter=" + encodeURIComponent("" + symptomFilter) + "&"; 
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfGetCoronaForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfGetCoronaForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfGetCoronaForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagedResultDtoOfGetCoronaForViewDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfGetCoronaForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getCoronaForView(id: number | undefined): Observable<GetCoronaForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Coronas/GetCoronaForView?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCoronaForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCoronaForView(<any>response_);
                } catch (e) {
                    return <Observable<GetCoronaForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCoronaForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCoronaForView(response: HttpResponseBase): Observable<GetCoronaForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetCoronaForViewDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetCoronaForViewDto>(<any>null);
    }
     ...
     * @return Success
     */
    getCoronaForEdit(id: number | undefined): Observable<GetCoronaForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Coronas/GetCoronaForEdit?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCoronaForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCoronaForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetCoronaForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCoronaForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetCoronaForEdit(response: HttpResponseBase): Observable<GetCoronaForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetCoronaForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetCoronaForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditCoronaDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Coronas/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Coronas/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
     ...
     * @return Success
     */
    getCoronasToExcel(filter: string | undefined, nameFilter: string | undefined, symptomFilter: string | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Coronas/GetCoronasToExcel?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCoronasToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCoronasToExcel(<any>response_);
                } catch (e) {
                    return <Observable<FileDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetCoronasToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    getPeople(filter: string | undefined): Observable<ListResultDtoOfPersonListDto> {
     ...
     * @return Success
     */
    createPerson(body: CreatePersonInput | undefined): Observable<void> {
...
export class CoronaDto implements ICoronaDto {
    name!: string | undefined;
    symptom!: string | undefined;
    id!: number;

    constructor(data?: ICoronaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CoronaDto {
        data = typeof data === 'object' ? data : {};
        let result = new CoronaDto();
        result.init(data);
        return result;
    }
...
export interface ICoronaDto {
    name: string | undefined;
    symptom: string | undefined;
    id: number;
}

export class GetCoronaForViewDto implements IGetCoronaForViewDto {
    corona!: CoronaDto;

    constructor(data?: IGetCoronaForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.corona = data["corona"] ? CoronaDto.fromJS(data["corona"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetCoronaForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetCoronaForViewDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["corona"] = this.corona ? this.corona.toJSON() : <any>undefined;
        return data; 
    }
}

export interface IGetCoronaForViewDto {
    corona: CoronaDto;
}

export class PagedResultDtoOfGetCoronaForViewDto implements IPagedResultDtoOfGetCoronaForViewDto {
    totalCount!: number;
    items!: GetCoronaForViewDto[] | undefined;

    constructor(data?: IPagedResultDtoOfGetCoronaForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(GetCoronaForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfGetCoronaForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfGetCoronaForViewDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfGetCoronaForViewDto {
    totalCount: number;
    items: GetCoronaForViewDto[] | undefined;
}

export class CreateOrEditCoronaDto implements ICreateOrEditCoronaDto {
    name!: string | undefined;
    symptom!: string | undefined;
    id!: number | undefined;

    constructor(data?: ICreateOrEditCoronaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditCoronaDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditCoronaDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditCoronaDto {
    name: string | undefined;
    symptom: string | undefined;
    id: number | undefined;
}

export class GetCoronaForEditOutput implements IGetCoronaForEditOutput {
    corona!: CreateOrEditCoronaDto;

    constructor(data?: IGetCoronaForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.corona = data["corona"] ? CreateOrEditCoronaDto.fromJS(data["corona"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetCoronaForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetCoronaForEditOutput();
        result.init(data);
        return result;
    }
...
export interface IGetCoronaForEditOutput {
    corona: CreateOrEditCoronaDto;
}
