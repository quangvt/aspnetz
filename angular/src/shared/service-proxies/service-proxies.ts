...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    deletePhone(id: number | undefined): Observable<void> {
     ...
     * @return Success
     */
    addPhone(body: AddPhoneInput | undefined): Observable<PhoneInPersonListDto> {
     ...
     * @return Success
     */
    getPersonForEdit(id: number | undefined): Observable<GetPersonForEditOutput> {
    ...
    protected processGetPersonForEdit(response: HttpResponseBase): Observable<GetPersonForEditOutput> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetPersonForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    editPerson(body: EditPersonInput | undefined): Observable<void> {
...
export class StudentServiceProxy {
     ...
     * @return Success
     */
    getStudent(filter: string | undefined): Observable<ListResultDtoOfStudentListDto> {
        let url_ = this.baseUrl + "/api/services/app/Student/GetStudent?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfStudentListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfStudentListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetStudent(response: HttpResponseBase): Observable<ListResultDtoOfStudentListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfStudentListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfStudentListDto>(<any>null);
    }
     ...
     * @return Success
     */
    createStudent(body: CreateStudentInput | undefined): Observable<void> {
    ...
    deleteStudent(id: number | undefined): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteStudent(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    editStudent(body: EditStudentInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Student/EditStudent";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditStudent(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditStudent(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processEditStudent(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ListResultDtoOfStudentListDto implements IListResultDtoOfStudentListDto {
    items!: StudentListDto[] | undefined;

    constructor(data?: IListResultDtoOfStudentListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(StudentListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfStudentListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfStudentListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfStudentListDto {
    items: StudentListDto[] | undefined;
}
...
export class EditStudentInput implements IEditStudentInput {
    id!: number;
    name!: string | undefined;
    surname!: string | undefined;
    emailAddress!: string | undefined;

    constructor(data?: IEditStudentInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): EditStudentInput {
        data = typeof data === 'object' ? data : {};
        let result = new EditStudentInput();
        result.init(data);
        return result;
    }
...
export interface IEditStudentInput {
    id: number;
    name: string | undefined;
    surname: string | undefined;
    emailAddress: string | undefined;
